...
| Name | Description |
|---|---|
| [Next.js](https://nextjs.org/) | React framework with routing, SSR, and server components. |
| [React Router (framework mode)](https://reactrouter.com/) | Full-stack React framework (successor to Remix). |
| [TanStack Start](https://tanstack.com/start) | Full-stack React/Solid framework built on TanStack Router. |
| [Nuxt](https://nuxt.com/) | Full-stack Vue framework. |
| [SvelteKit](https://svelte.dev/docs/kit) | Official full-stack Svelte framework. |
| [SolidStart](https://start.solidjs.com/) | Full-stack Solid framework. |
| [Analog](https://analogjs.org/) | Full-stack Angular meta-framework powered by Vite. |
| [Astro](https://astro.build/) | Content-driven framework with islands; use any UI library. |
...
| Name | Description |
|---|---|
| [shadcn/ui](https://ui.shadcn.com/) | Copy-paste components built on Radix/Base UI and Tailwind. |
| [daisyUI](https://daisyui.com/) | Component classes plugin for Tailwind CSS. |
| [MUI](https://mui.com/) | React components implementing Material Design. |
| [Mantine](https://mantine.dev/) | Full-featured React components and hooks library. |
| [Chakra UI](https://chakra-ui.com/) | Accessible React component system. |
| [Ant Design](https://ant.design/) | Enterprise-class React UI library. |
| [Vuetify](https://vuetifyjs.com/) | Material Design component framework for Vue. |
| [PrimeVue](https://primevue.org/) | Rich UI component suite for Vue. |
| [Angular Material](https://material.angular.dev/) | Material Design components for Angular. |
| [Skeleton](https://www.skeleton.dev/) | Adaptive design system for Svelte and React with Tailwind. |
| [Shoelace / Web Awesome](https://shoelace.style/) | Framework-agnostic Web Components. |
...
| [Base UI](https://base-ui.com/) | Unstyled React components from the Radix, MUI, and Floating UI teams. |
| [React Aria](https://react-spectrum.adobe.com/react-aria/) | Adobe's accessible UI primitives and hooks. |
| [Headless UI](https://headlessui.com/) | Unstyled components by the Tailwind team (React/Vue). |
| [Ark UI](https://ark-ui.com/) | Headless components for React, Vue, Solid, and Svelte. |
| [Bits UI](https://bits-ui.com/) | Headless components for Svelte. |
| [Floating UI](https://floating-ui.com/) | Positioning for tooltips, popovers, and dropdowns. |
| [TanStack Table](https://tanstack.com/table) | Headless tables and datagrids for any framework. |
...
| Name | Description |
|---|---|
| [TanStack Query](https://tanstack.com/query) | Server-state fetching, caching, and syncing. |
| [SWR](https://swr.vercel.app/) | React hooks for data fetching with stale-while-revalidate. |
| [Zustand](https://zustand.docs.pmnd.rs/) | Small, fast React state management. |
| [Jotai](https://jotai.org/) | Primitive, flexible atomic state for React. |
| [Redux Toolkit](https://redux-toolkit.js.org/) | Official, batteries-included Redux. |
| [Pinia](https://pinia.vuejs.org/) | Intuitive store for Vue. |
| [XState](https://stately.ai/docs/xstate) | State machines and actors for complex logic. |
| [Nano Stores](https://github.com/nanostores/nanostores) | Tiny framework-agnostic state manager. |
...
| [TanStack Form](https://tanstack.com/form) | Headless, type-safe form state for any framework. |
| [Zod](https://zod.dev/) | TypeScript-first schema validation. |
| [Valibot](https://valibot.dev/) | Modular, tiny schema validation library. |
...
| Name | Description |
|---|---|
| [TanStack Router](https://tanstack.com/router) | Fully type-safe router for React and Solid. |
